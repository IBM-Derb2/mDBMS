...
class TestTransactionManager(unittest.TestCase):
    ...
    def test_terminate_transaction(self):
        ...
        self.assertEqual(self.manager.get_transaction(5).status, TransactionStatus.TERMINATED)
...
class TestEndTransactionManager(unittest.TestCase):
    ...
    def test_commit_success(self):
        ...
        self.assertEqual(report.result, EndTransactionResult.SUCCESS)
        self.assertEqual(self.tx_manager.get_transaction(tx_id).status, TransactionStatus.TERMINATED)
